    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-[#12121a] border border-[#1e1e2e] rounded-lg p-8">
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 text-blue-400 px-4 py-3 rounded-md mb-6 text-sm">
          <p className="font-semibold mb-1">{t('demoAccount')}</p>
          <p>{t('demoEmail')} <code className="bg-blue-500/20 px-1.5 py-0.5 rounded">demo@marketwhisper.com</code></p>
          <p>{t('demoPassword')} <code className="bg-blue-500/20 px-1.5 py-0.5 rounded">MarketWhisper2026!</code></p>
        </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-[#12121a] text-gray-500">{tCommon('or')}</span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full py-2.5 px-4 bg-white hover:bg-gray-100 text-gray-900 font-medium rounded-md transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full py-2.5 px-4 bg-[#24292e] hover:bg-[#2f363d] text-white font-medium rounded-md transition-colors flex items-center justify-center gap-2"
          >
